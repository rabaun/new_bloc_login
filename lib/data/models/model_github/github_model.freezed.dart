...
abstract class $GitHubModelCopyWith<$Res> {
  factory $GitHubModelCopyWith(
      ...
      _$GitHubModelCopyWithImpl<$Res, GitHubModel>;
  @useResult
  $Res call(
      {int? id,
      ...
      @JsonKey(name: "license") Map<String, dynamic>? license,
      ...
      int? watchers,
      @JsonKey(name: "default_branch") String? default_branch});

  $OwnerModelCopyWith<$Res>? get owner;
}

/// @nodoc
class _$GitHubModelCopyWithImpl<$Res, $Val extends GitHubModel>
...
/// @nodoc
abstract class _$$_GitHubModelCopyWith<$Res>
    implements $GitHubModelCopyWith<$Res> {
  factory _$$_GitHubModelCopyWith(
          _$_GitHubModel value, $Res Function(_$_GitHubModel) then) =
      __$$_GitHubModelCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? id,
...
/// @nodoc
class __$$_GitHubModelCopyWithImpl<$Res>
    extends _$GitHubModelCopyWithImpl<$Res, _$_GitHubModel>
    implements _$$_GitHubModelCopyWith<$Res> {
  __$$_GitHubModelCopyWithImpl(
      _$_GitHubModel _value, $Res Function(_$_GitHubModel) _then)
      : super(_value, _then);
...
class _$_GitHubModel implements _GitHubModel {
  const _$_GitHubModel(
      ...
      @JsonKey(name: "forks_count") this.forks_count,
      @JsonKey(name: "mirror_url") this.mirrorUrl,
      this.archived,
      this.disabled,
      @JsonKey(name: "open_issues_count") this.openIssuesCount,
      @JsonKey(name: "license") final Map<String, dynamic>? license,
      ...
      this.watchers,
      @JsonKey(name: "default_branch") this.default_branch})
      : _license = license,
        _topics = topics;
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.forks_count, forks_count) || other.forks_count == forks_count) &&
            ...
            (identical(other.default_branch, default_branch) || other.default_branch == default_branch));
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_GitHubModelCopyWith<_$_GitHubModel> get copyWith =>
      __$$_GitHubModelCopyWithImpl<_$_GitHubModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_GitHubModelToJson(
      this,
    );
  }
}
...
abstract class _GitHubModel implements GitHubModel {
  const factory _GitHubModel(
          ...
          final bool? private,
          @JsonKey(name: "owner") final OwnerModel? owner,
          ...
          @JsonKey(name: "forks_count") final int? forks_count,
          ...
          final int? watchers,
          @JsonKey(name: "default_branch") final String? default_branch}) =
      _$_GitHubModel;
