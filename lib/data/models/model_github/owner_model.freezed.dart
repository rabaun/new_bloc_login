...
mixin _$OwnerModel {
  ...
  @JsonKey(name: "received_eventsUrl")
...
class _$_OwnerModel implements _OwnerModel {
  const _$_OwnerModel(
      ...
      @JsonKey(name: "received_eventsUrl") this.receivedEventsUrl,
      this.type,
...
abstract class _OwnerModel implements OwnerModel {
  const factory _OwnerModel(
      ...
      @JsonKey(name: "received_eventsUrl") final String? receivedEventsUrl,
      final String? type,
      @JsonKey(name: "site_admin") final bool? siteAdmin}) = _$_OwnerModel;
